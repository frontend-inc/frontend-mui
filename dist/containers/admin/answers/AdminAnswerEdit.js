...
var AdminAnswerEdit = function (props) {
    ...
    return (react_1.default.createElement(components_1.Drawer, { mode: "editor", open: open, handleClose: handleClose, title: title ? title : (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Edit' : 'Add', buttons: react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, startIcon: loading && react_1.default.createElement(components_1.IconLoading, null) }, (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Update' : 'Save') },
