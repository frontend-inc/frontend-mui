        ...
        react_1.default.createElement("div", { className: "flex flex-row w-full justify-between items-start space-x-2" },
            react_1.default.createElement("div", { className: "flex flex-row space-x-4" },
                ...
                react_1.default.createElement("div", { className: "flex flex-col" },
                    react_1.default.createElement(tailwind_1.Typography, { variant: "subtitle1", color: "text.primary" }, question === null || question === void 0 ? void 0 : question.title),
                    react_1.default.createElement(tailwind_1.Typography, { variant: "body2", color: "text.secondary" }, question === null || question === void 0 ? void 0 : question.description))),
