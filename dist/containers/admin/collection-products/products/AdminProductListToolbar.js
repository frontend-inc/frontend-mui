...
var collapsible_1 = require("../../../../shadcn/ui/collapsible");
...
function AdminProductToolbar(_a) {
    ...
    return (react_1.default.createElement("div", { className: "sticky top-0 z-10 pb-2 shadow-md bg-background" },
        react_1.default.createElement(collapsible_1.Collapsible, { open: selectedIds.length > 0 },
            react_1.default.createElement(collapsible_1.CollapsibleContent, { className: "space-y-2" },
                react_1.default.createElement("div", { className: "flex space-x-2" },
                    react_1.default.createElement(button_1.Button, { className: "w-full", onClick: handleAddProducts },
