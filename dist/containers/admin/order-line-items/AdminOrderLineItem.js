...
var AdminOrderLineItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, __assign({ selectable: selectable, selected: selected, image: (_a = orderLineItem === null || orderLineItem === void 0 ? void 0 : orderLineItem.product_data) === null || _a === void 0 ? void 0 : _a.image_url, avatar: react_1.default.createElement(tailwind_1.Badge, { badgeContent: 2 },
