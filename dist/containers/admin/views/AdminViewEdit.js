...
var AdminViewEdit = function (props) {
    ...
    return (react_1.default.createElement(components_1.Drawer, { mode: "editor", loading: loading, open: open, handleClose: handleClose, title: "Save view", buttons: react_1.default.createElement(components_1.PrimaryButton, { loading: loading, onClick: handleSubmit }, "Save") },
