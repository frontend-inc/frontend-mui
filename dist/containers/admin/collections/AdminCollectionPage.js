    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(components_1.AdminLayoutCenter, null,
            react_1.default.createElement(components_1.AdminHeader, { enableExpandLeftPanel: true, buttons: collectionId && (react_1.default.createElement("div", { className: "flex flex-row items-center space-x-2" },
                    react_1.default.createElement(tailwind_1.Button, { variant: "contained", color: "primary", onClick: handleAddClick, startIcon: react_1.default.createElement(lucide_react_1.Plus, { className: "w-5 h-5 text-primary-foreground" }) }, "Add"),
                    react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return setOpenAiModal(true); } },
                        react_1.default.createElement(components_2.Icon, { name: "Wand", color: "text.primary" })))), secondaryActions: react_1.default.createElement(CollectionSchemaToggle_1.default, { tab: 'content' }) }),
