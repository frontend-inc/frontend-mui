...
var AdminOrderDetails = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "grid grid-cols-2 gap-4 ".concat(loading ? 'opacity-50' : '') },
        react_1.default.createElement("div", { className: "flex flex-row space-x-2" },
            react_1.default.createElement(tailwind_1.Typography, { variant: "subtitle1", color: "text.primary" },
                "Order ",
        ...
        react_1.default.createElement("div", { className: "bg-card p-4 rounded-lg shadow" },
            react_1.default.createElement("div", { className: "flex flex-col" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(button_1.Button, { variant: "ghost", className: "mt-1 p-0.5 text-foreground", onClick: handleCopyEmail },
                        react_1.default.createElement(components_1.Icon, { name: "Mail", size: 20, className: "mr-2" }),
                        order.customer_name)),
                react_1.default.createElement(tailwind_1.Typography, { variant: "overline", color: "text.secondary", className: "whitespace-pre-line" }, order.shipping_address))),
        react_1.default.createElement("div", { className: "bg-card p-4 rounded-lg shadow" },
            react_1.default.createElement("div", { className: "flex flex-col" },
                react_1.default.createElement(tailwind_1.Typography, { variant: "overline", color: "text.secondary" },
                    "Subtotal: ",
