...
var AdminFieldItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, { enableBorder: true, sortable: sortable, avatar: react_1.default.createElement(__1.FieldIcon, { variant: field === null || field === void 0 ? void 0 : field.variant }), primary: react_1.default.createElement("div", { className: "flex flex-row space-x-1" },
            react_1.default.createElement(tailwind_1.Typography, { variant: "body1", color: "text.primary" }, field === null || field === void 0 ? void 0 : field.label),
            ...
            field.column && !field.array && (react_1.default.createElement(tooltip_1.TooltipProvider, null,
                react_1.default.createElement(tooltip_1.Tooltip, null,
                    react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                        react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return handleUpdateField('filter_field'); } },
            ...
            field.column && !field.array && (react_1.default.createElement(tooltip_1.TooltipProvider, null,
                react_1.default.createElement(tooltip_1.Tooltip, null,
                    react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                        react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return handleUpdateField('sort_field'); } },
            ...
            (field.column || field.attachment) && (field === null || field === void 0 ? void 0 : field.name) != 'title' && (react_1.default.createElement(tooltip_1.TooltipProvider, null,
                react_1.default.createElement(tooltip_1.Tooltip, null,
                    react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                        react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return handleUpdateField('display_field'); } },
