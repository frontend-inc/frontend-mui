...
var FieldIcon = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)(field === null || field === void 0 ? void 0 : field.color, 'p-[5px] mr-1 rounded-lg flex items-center justify-center'), style: {
