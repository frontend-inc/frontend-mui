...
var DocumentListItem = function (props) {
    ...
    return (react_1.default.createElement("li", { className: (0, utils_1.cn)('bg-background rounded border-2 border-border mb-1 overflow-hidden transition-colors duration-200 ease-in-out', selected && 'border-primary') },
        react_1.default.createElement("div", { className: "flex items-center p-0 cursor-pointer", onClick: handleClick },
            ...
            react_1.default.createElement("div", { className: "flex-grow" },
                react_1.default.createElement(tailwind_1.Typography, { variant: "body2", color: "text.primary", className: "max-w-[146px]" }, (0, helpers_1.truncate)(document === null || document === void 0 ? void 0 : document.title))),
