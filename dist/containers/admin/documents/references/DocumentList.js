...
var DocumentListDrawer = function (props) {
    ...
    return (react_1.default.createElement(components_1.Drawer, { mode: "editor", open: open, title: "Add ".concat((_b = field === null || field === void 0 ? void 0 : field.foreign_collection) === null || _b === void 0 ? void 0 : _b.singular_name), handleClose: handleClose, buttons: react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", disabled: !selected, onClick: handleAddClick }, "Add") },
        ...
        numPages > page && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, onClick: handleLoadMore, endIcon: loading ? (react_1.default.createElement(tailwind_1.CircularProgress, null)) : (react_1.default.createElement(lucide_react_1.ChevronDown, { className: "w-5 h-5 text-foreground" })) }, "Load More"))));
};
