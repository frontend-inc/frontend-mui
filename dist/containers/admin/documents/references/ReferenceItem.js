...
var SortableReferenceItem = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-row bg-background border-2 border-border rounded-md p-0 mb-1 w-full', item.isDragging && 'bg-background-hover') },
                ...
                react_1.default.createElement("div", { className: "flex items-center" },
                    ...
                    react_1.default.createElement(dropdown_menu_1.DropdownMenu, null,
                        ...
                        react_1.default.createElement(dropdown_menu_1.DropdownMenuContent, null,
                            react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: function () { return handleEditItem(target); } }, "Edit"),
                            react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: function () { return handleRemoveItem(item); } }, "Remove"))))),
