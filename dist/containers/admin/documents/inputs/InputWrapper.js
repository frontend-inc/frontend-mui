...
var DocumentInputWrapper = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('w-full flex flex-row justify-start items-start', !disablePadding && 'pb-2') },
        expandable && (react_1.default.createElement("div", null,
            react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return setOpen(!open); } },
                react_1.default.createElement(lucide_react_1.ChevronDown, { className: (0, utils_1.cn)('h-5 w-5 rounded text-gray-500 bg-gray-100 transition-transform duration-200', !open && 'rotate-[-90deg]') })))),
        react_1.default.createElement("div", { className: (0, utils_1.cn)('flex-grow sm:flex-grow-[0.5] w-full pr-0 pl-1 border-l-3 border-transparent hover:border-primary transition-colors duration-300 ease-in-out') },
            react_1.default.createElement("div", { className: "flex flex-row justify-between items-center" },
                react_1.default.createElement(tailwind_1.Typography, { variant: "overline", color: "text.secondary" }, title),
