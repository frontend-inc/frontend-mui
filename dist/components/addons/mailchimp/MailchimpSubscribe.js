...
var MailchimpSubscribe = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "py-2 w-full flex flex-col items-center justify-center" },
        react_1.default.createElement("div", { className: "flex flex-row max-w-[400px]" },
            ...
            react_1.default.createElement(tailwind_1.Button, { variant: "contained", color: "secondary", onClick: handleFormSubmit, className: "min-w-[120px] rounded-l-none" }, loading ? react_1.default.createElement(__1.IconLoading, null) : buttonText))));
};
