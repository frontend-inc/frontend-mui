...
function GoogleMap(_a) {
    ...
    if ((googleMarkers === null || googleMarkers === void 0 ? void 0 : googleMarkers.length) <= 0)
        return null;
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('sticky rounded overflow-hidden transition-shadow duration-300 hover:shadow-md', enableBorder && 'border border-divider'), style: {
            height: height,
            width: width || '100%',
        } },
