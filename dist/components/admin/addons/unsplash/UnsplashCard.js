...
var UnplashCard = function (_a) {
    ...
    return (react_1.default.createElement(card_1.Card, { className: (0, utils_1.cn)('rounded bg-background border border-border p-0', selected && 'border-primary') },
        ...
        react_1.default.createElement(card_1.CardHeader, { className: "p-1" },
            react_1.default.createElement(button_1.Button, { variant: "ghost", className: "text-xs text-muted-foreground hover:text-foreground flex items-center space-x-2 p-0", onClick: function () { return handleProfileClick(image === null || image === void 0 ? void 0 : image.user); } },
                react_1.default.createElement(avatar_1.Avatar, { className: "h-6 w-6" },
                    react_1.default.createElement(avatar_1.AvatarImage, { src: (_d = (_c = image === null || image === void 0 ? void 0 : image.user) === null || _c === void 0 ? void 0 : _c.profile_image) === null || _d === void 0 ? void 0 : _d.medium, alt: (_e = image === null || image === void 0 ? void 0 : image.user) === null || _e === void 0 ? void 0 : _e.name }),
                    react_1.default.createElement(avatar_1.AvatarFallback, null, (_g = (_f = image === null || image === void 0 ? void 0 : image.user) === null || _f === void 0 ? void 0 : _f.name) === null || _g === void 0 ? void 0 : _g.charAt(0))),
