...
var UnsplashLogo = function (_a) {
    var _b = _a.width, width = _b === void 0 ? 100 : _b;
    return (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 457.2 104.2", width: width, height: (width * 104.2) / 457.2, className: "fill-white", "aria-label": "Unsplash logo (light version)" },
...
var UnsplashBranding = function (_a) {
    var _b = _a.width, width = _b === void 0 ? 80 : _b;
    return react_1.default.createElement(UnsplashLogo, { width: width });
};
exports.default = UnsplashBranding;
