...
var StripeConnectButton = function () {
    ...
    return (react_1.default.createElement(tailwind_1.Button, { variant: "contained", color: "primary", onClick: handleClick, className: "bg-[#6772E5] hover:bg-[#6772E5]" }, loading ? 'Connecting...' : 'Connect with Stripe'));
};
