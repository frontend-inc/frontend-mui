...
function AdminHeader(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('w-full flex flex-row items-center h-[50px] min-h-[50px] px-2 bg-background', !disableBorder && 'border-b border-border') },
        react_1.default.createElement("div", { className: "grid grid-cols-3 gap-1 w-full" },
            react_1.default.createElement("div", { className: "flex flex-row items-center h-full" },
                ...
                primaryActions,
                title && (react_1.default.createElement(tailwind_1.Typography, { variant: "body1", className: "leading-none break-keep text-foreground" }, title))),
