...
function AdminLayout(_a) {
    ...
    return (react_1.default.createElement("div", { className: "editor w-full" },
        react_1.default.createElement("div", { className: (0, utils_1.cn)('w-screen overflow-x-hidden scrollbar-hide', 'flex flex-row min-h-screen') },
            ...
            react_1.default.createElement("div", { className: (0, utils_1.cn)('w-[calc(100vw-60px)] overflow-x-hidden scrollbar-hide', 'flex sm:flex-row xs:flex-col') }, children))));
}
