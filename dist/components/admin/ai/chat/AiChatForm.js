...
var AiChatForm = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex p-2 flex-col space-y-4" },
        ...
        react_1.default.createElement(scroll_area_1.ScrollArea, { className: "max-h-[calc(100vh-120px)] w-full" },
            react_1.default.createElement("ul", { className: "flex flex-col space-y-2" }, messages
