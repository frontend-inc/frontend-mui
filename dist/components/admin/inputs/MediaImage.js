...
var MediaImage = function (_a) {
    ...
    return (react_1.default.createElement(card_1.Card, { className: "relative h-40 p-0 rounded border border-border bg-background" },
        react_1.default.createElement(card_1.CardContent, { className: "p-0 h-full" },
            ...
            (image === null || image === void 0 ? void 0 : image.url) && (react_1.default.createElement(button_1.Button, { variant: "secondary", size: "icon", className: "absolute top-1 right-1 opacity-50 hover:opacity-100 bg-background text-foreground", onClick: handleRemove },
