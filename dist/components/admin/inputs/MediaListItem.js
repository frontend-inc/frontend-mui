...
var MediaItem = function (_a) {
    ...
    return (react_1.default.createElement(card_1.Card, { className: (0, utils_1.cn)('rounded-md bg-background p-0 min-w-[120px] h-[208px] border border-transparent', selected && 'border-primary') },
        react_1.default.createElement(card_1.CardHeader, { className: "py-1 px-1 flex flex-row justify-between items-center" },
            ...
            handleRemove && (react_1.default.createElement(dropdown_menu_1.DropdownMenu, null,
                ...
                react_1.default.createElement(dropdown_menu_1.DropdownMenuContent, { align: "end" },
                    react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleRemove }, "Remove"))))),
