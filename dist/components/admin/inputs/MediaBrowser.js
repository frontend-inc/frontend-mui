...
var MediaBrowser = function (_a) {
    ...
    return (react_1.default.createElement(components_1.Modal, { mode: "editor", maxWidth: "md", open: open, handleClose: handleClose, title: 'Browse Media', buttons: react_1.default.createElement(button_1.Button, { variant: "default", onClick: handleAttach }, "Save Media") },
        react_1.default.createElement("div", { className: "flex flex-col h-full" },
            react_1.default.createElement("div", { className: "px-4 flex justify-center items-center" },
            ...
            react_1.default.createElement("div", { className: "p-4 min-h-[50vh]" },
