...
var VideoModal = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "dark" },
        react_1.default.createElement(__1.Modal, { open: open, handleClose: handleClose, maxWidth: "md", title: title, buttons: react_1.default.createElement(react_1.default.Fragment, null,
                enableCopy && (react_1.default.createElement(tailwind_1.Button, { color: "secondary", variant: "contained", startIcon: react_1.default.createElement(lucide_react_1.Link, null), onClick: handleCopyUrlClick }, "Copy URL")),
                enableDownload && (react_1.default.createElement(tailwind_1.Button, { color: "primary", variant: "contained", startIcon: react_1.default.createElement(lucide_react_1.Download, null), onClick: handleDownloadClick }, "Download"))) },
