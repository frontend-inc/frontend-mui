...
var ResetPasswordForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        ...
        react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, endIcon: loading && react_1.default.createElement(components_1.IconLoading, null) }, "Save and Continue"),
        handleLogin && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "primary", onClick: handleLogin }, "Back to login"))));
};
