...
var ForgotPasswordForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        ...
        react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, startIcon: loading && react_1.default.createElement(__1.IconLoading, null) }, "Send Instructions"),
        handleLogin && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "text", onClick: handleLogin }, "Back to Login"))));
};
