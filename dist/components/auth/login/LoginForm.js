...
var LoginForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4 w-full" },
        ...
        react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
            react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "primary", onClick: handleSubmit, variant: "contained", loading: loading }, "Sign In"),
            handleSignup && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "secondary", variant: "contained", onClick: handleSignup }, "No account? Sign up")),
            handleForgotPassword && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "secondary", variant: "text", onClick: handleForgotPassword }, "Forgot password?")),
            handleOneTimePassword && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "secondary", variant: "text", onClick: handleOneTimePassword }, "One-time password")))));
};
