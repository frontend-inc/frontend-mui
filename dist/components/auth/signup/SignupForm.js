...
var SignupForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4 w-full" },
        ...
        react_1.default.createElement("div", { className: "flex flex-col space-y-3 w-full" },
            react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "primary", onClick: handleSubmit, variant: "contained", startIcon: loading && react_1.default.createElement(__1.IconLoading, null) }, "Register"),
            handleLogin && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "secondary", variant: "text", onClick: handleLogin }, "Already have an account? Sign in")))));
};
