...
var AuthButton = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        !showLabel ? (react_1.default.createElement(react_1.default.Fragment, null, (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id) ? (react_1.default.createElement(tailwind_1.IconButton, { onClick: toggleMenu },
            react_1.default.createElement(__1.UserAvatar, { user: currentUser }))) : (react_1.default.createElement(tailwind_1.IconButton, { onClick: handleLogin },
            react_1.default.createElement(__1.Icon, { name: "User", size: 24 }))))) : (react_1.default.createElement(react_1.default.Fragment, null, (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id) ? (react_1.default.createElement(tailwind_1.Button, { onClick: toggleMenu, startIcon: showIcon && react_1.default.createElement(__1.UserAvatar, { user: currentUser }), endIcon: react_1.default.createElement("div", null,
                react_1.default.createElement(__1.Icon, { name: "MoreVertical" })) },
            react_1.default.createElement(tailwind_1.Typography, { variant: "body1", color: "text.primary" }, currentUser === null || currentUser === void 0 ? void 0 : currentUser.username))) : (react_1.default.createElement(tailwind_1.Button, { onClick: handleLogin, startIcon: showIcon && react_1.default.createElement(__1.Icon, { name: "User", size: 24 }) }, "Sign In")))),
