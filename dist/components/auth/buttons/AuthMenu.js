...
var AuthMenu = function (_a) {
    ...
    return (react_1.default.createElement(dropdown_menu_1.DropdownMenu, { open: open, onOpenChange: function (isOpen) { return !isOpen && toggleMenu(null); } },
        react_1.default.createElement(dropdown_menu_1.DropdownMenuTrigger, { asChild: true },
            react_1.default.createElement(button_1.Button, { variant: "ghost", className: "h-8 w-8 rounded-full" },
                react_1.default.createElement(components_1.UserAvatar, { size: 32, user: currentUser }))),
        react_1.default.createElement(dropdown_menu_1.DropdownMenuContent, { className: "w-56", align: "end", forceMount: true }, currentUser ? (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(dropdown_menu_1.DropdownMenuLabel, { className: "font-normal" },
            ...
            react_1.default.createElement(dropdown_menu_1.DropdownMenuGroup, null,
                react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleMyAccount },
            ...
            react_1.default.createElement(dropdown_menu_1.DropdownMenuSeparator, null),
            react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleLogout },
            ...
            react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleLogin },
            ...
            react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleSignup },
