...
var SendPinForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-3" },
        ...
        react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, startIcon: loading && react_1.default.createElement(__1.IconLoading, null) }, "Send Verification Pin"),
        handleLogin && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "text", color: "primary", onClick: handleLogin }, "Cancel"))));
};
