...
var StripeCustomerPortalButton = function () {
    ...
    return (react_1.default.createElement(tailwind_1.Button, { variant: "contained", color: "primary", onClick: handleClick }, loading ? 'Connecting...' : 'Manage Payments with Stripe'));
};
