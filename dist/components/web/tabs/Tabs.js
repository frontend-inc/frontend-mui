...
var CustomTabs = function (_a) {
    ...
    return (react_1.default.createElement(tabs_1.Tabs, { defaultValue: "0", className: "w-full" },
        react_1.default.createElement(tabs_1.TabsList, { className: "flex justify-center mb-4" }, items.map(function (item, i) { return (react_1.default.createElement(tabs_1.TabsTrigger, { key: i, value: i.toString(), className: "flex items-center justify-center" },
            item.icon && (react_1.default.createElement(components_1.Icon, { name: item.icon, className: "w-5 h-5 mr-2 text-current" })),
            item.label)); })),
        items.map(function (item, i) { return (react_1.default.createElement(tabs_1.TabsContent, { key: i, value: i.toString() },
