...
var SocialButtons = function (props) {
    ...
    if (!enableLikes &&
        ...
        !enableProductLikes)
        return null;
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex', size == 'small' ? 'space-x-1' : 'space-x-2', direction == 'row' && 'flex-row', justifyContent == 'flex-start' && 'justify-start', justifyContent == 'center' && 'justify-center') },
