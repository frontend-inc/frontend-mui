    ...
    return (react_1.default.createElement(components_1.AuthGuard, null,
        react_1.default.createElement("div", { className: "pl-0" },
            react_1.default.createElement("div", { className: "flex flex-col space-y-4 w-full items-start" },
                ...
                react_1.default.createElement(button_1.Button, { variant: "default", onClick: handleSubmit, disabled: loading, className: "flex items-center" },
                    loading && react_1.default.createElement(components_1.IconLoading, { className: "mr-2 h-4 w-4 animate-spin" }),
                    "Submit")))));
};
