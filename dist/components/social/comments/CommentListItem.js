...
var CommentListItem = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "py-2" },
        react_1.default.createElement("div", { className: "flex items-start space-x-4" },
            ...
            react_1.default.createElement("div", { className: "flex-grow" },
                react_1.default.createElement("div", { className: "space-y-1" },
                    react_1.default.createElement(tailwind_1.Typography, { variant: "body2", color: "text.secondary" }, "@".concat((_a = parentComment === null || parentComment === void 0 ? void 0 : parentComment.user) === null || _a === void 0 ? void 0 : _a.username),
                        " -",
                        ' ',
                        (0, moment_1.default)(parentComment === null || parentComment === void 0 ? void 0 : parentComment.created_at).fromNow()),
                    react_1.default.createElement(tailwind_1.Typography, { variant: "body1", color: "text.primary", className: "mb-2 whitespace-pre-wrap" }, parentComment === null || parentComment === void 0 ? void 0 : parentComment.body)),
                react_1.default.createElement(button_1.Button, { variant: "link", onClick: handleReply, className: "text-muted-foreground hover:text-foreground" }, "reply"))),
        react_1.default.createElement(tailwind_1.Collapse, { in: openComment },
        ...
        ((_b = parentComment === null || parentComment === void 0 ? void 0 : parentComment.replies) === null || _b === void 0 ? void 0 : _b.length) > 0 && (react_1.default.createElement(react_1.default.Fragment, null, !showReplies && (react_1.default.createElement("div", null,
            react_1.default.createElement(button_1.Button, { variant: "link", className: "text-muted-foreground hover:text-foreground", onClick: handleShowReplies },
        ...
        react_1.default.createElement(tailwind_1.Collapse, { in: showReplies }, (_e = parentComment === null || parentComment === void 0 ? void 0 : parentComment.replies) === null || _e === void 0 ? void 0 : _e.map(function (reply) { return (react_1.default.createElement(CommentListItem, { key: reply.id, reply: true, url: url, handle: handle, comment: reply, level: level + 1, handleDelete: handleDelete })); }))));
};
