...
function ProductFavoriteButton(_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(tailwind_1.IconButton, { onClick: handleClick, className: (0, utils_1.cn)(color, "hover:".concat(color), size === 'large' &&
            ...
            react_1.default.createElement(lucide_react_1.Bookmark, { className: (0, utils_1.cn)('w-4 h-4 text-foreground', isFavorite ? 'fill-current ' : 'stroke-current') }))));
}
