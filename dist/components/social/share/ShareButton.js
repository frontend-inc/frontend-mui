...
function ShareButton(_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(tailwind_1.IconButton, { onClick: handleClick, className: (0, utils_1.cn)(variant == 'circular' ? 'rounded-full' : 'rounded-lg', 'text-foreground', size === 'large' && 'border border-divider') },
            ...
            react_1.default.createElement("div", { className: "p-4" },
                react_1.default.createElement("div", { className: "space-y-6" },
                    react_1.default.createElement("div", { className: "w-full" },
                        react_1.default.createElement(tailwind_1.Typography, { variant: "subtitle1", textAlign: "center" }, "Share to social media"),
                        react_1.default.createElement(tailwind_1.Typography, { variant: "body2", textAlign: "center" }, "Select your social media platform")),
