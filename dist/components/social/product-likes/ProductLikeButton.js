...
function ProductLikeButton(_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(tailwind_1.IconButton, { onClick: handleClick, className: (0, utils_1.cn)(size === 'large' && 'border border-divider', size === 'large' && liked && 'bg-primary hover:bg-primary-dark', 'transition-transform duration-200', liked && 'transform scale-110') },
            react_1.default.createElement(lucide_react_1.Heart, { className: (0, utils_1.cn)('w-5 h-5 text-foreground', liked ? 'fill-current' : 'stroke-current') }))));
}
