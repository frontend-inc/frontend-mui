...
function FavoriteButton(_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(tailwind_1.IconButton, { onClick: handleClick, className: (0, utils_1.cn)(variant == 'circular' ? 'rounded-full' : 'rounded-lg', size === 'large' && 'border border-divider', 'transition-transform duration-200', isFavorite && 'transform scale-110') },
            react_1.default.createElement(lucide_react_1.Bookmark, { className: (0, utils_1.cn)('w-5 h-5 text-foreground', isFavorite ? 'fill-current' : 'stroke-current') }))));
}
