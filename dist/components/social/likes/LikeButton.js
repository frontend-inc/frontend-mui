...
function LikeButton(_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(tailwind_1.IconButton, { onClick: handleClick, className: (0, utils_1.cn)(variant == 'circular' ? 'rounded-full' : 'rounded-lg', size === 'large' && 'border border-divider', 'transition-transform duration-200', liked && 'transform scale-110') },
