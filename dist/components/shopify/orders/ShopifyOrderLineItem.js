...
var ShopifyOrderLineItem = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex items-start space-x-4 py-2', className) },
        react_1.default.createElement("div", { className: "relative flex-shrink-0" }, ((_c = (_b = lineItem === null || lineItem === void 0 ? void 0 : lineItem.variant) === null || _b === void 0 ? void 0 : _b.image) === null || _c === void 0 ? void 0 : _c.url) && (react_1.default.createElement("div", { className: "relative" },
            ...
            react_1.default.createElement(badge_1.Badge, { className: "absolute -top-2 -right-2 h-6 w-6 rounded-full flex items-center justify-center bg-primary text-primary-foreground" }, lineItem.quantity)))),
