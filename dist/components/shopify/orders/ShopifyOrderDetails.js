...
var ShopifyOrderDetails = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-col space-y-4', className) },
        react_1.default.createElement("h3", { className: "text-lg font-semibold" }, "Order details"),
        react_1.default.createElement(scroll_area_1.ScrollArea, { className: "h-[200px] w-full rounded-md border p-4" }, lineItems === null || lineItems === void 0 ? void 0 : lineItems.map(function (lineItem, i) { return (react_1.default.createElement(shopify_1.ShopifyOrderLineItem, { key: i, lineItem: lineItem })); })),
        ...
        react_1.default.createElement(button_1.Button, { className: "w-full", variant: "default", onClick: handleOrderStatusClick },
            "Order status",
            react_1.default.createElement(lucide_react_1.ExternalLink, { className: "ml-2 h-4 w-4" })),
        supportUrl && (react_1.default.createElement(button_1.Button, { className: "w-full", variant: "outline", onClick: handleSupportClick }, "Customer support"))));
};
