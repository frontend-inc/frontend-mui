...
var ShopifyOrderItem = function (_a) {
    ...
    return (react_1.default.createElement(button_1.Button, { variant: "ghost", className: (0, utils_1.cn)('w-full justify-start text-left hover:bg-accent', className), onClick: function () { return handleClick(order); } },
        react_1.default.createElement("div", { className: "flex items-center space-x-4" },
            react_1.default.createElement("div", { className: "flex-shrink-0" },
                react_1.default.createElement(components_1.Image, { alt: (order === null || order === void 0 ? void 0 : order.name) || 'Order image', src: 
                    //@ts-ignore
