...
var ShopifyProductSearch = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "pt-2" },
        react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-col sm:flex-row justify-between items-center mb-1', 'sm:ml-1 ml-0') }, enableSorting && (react_1.default.createElement(__2.ShopifyProductSortButton, { sortKey: sortKey, reverse: reverse, handleClick: handleSortClick }))),
        react_1.default.createElement("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-4" },
            ...
            react_1.default.createElement("div", { className: (0, utils_1.cn)('col-span-1', enableFilters ? 'md:col-span-9' : 'md:col-span-12') },
