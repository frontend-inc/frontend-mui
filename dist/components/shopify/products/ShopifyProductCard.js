...
function ShopifyProductCard(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)(!disableBorder && 'border border-border hover:shadow-md', 'w-full overflow-hidden rounded-lg transition-shadow duration-300 bg-background') },
        ...
        react_1.default.createElement(card_1.CardContent, null,
            react_1.default.createElement("div", { className: "flex flex-col py-1" },
                react_1.default.createElement(tailwind_1.Typography, { color: "text.primary", variant: "subtitle2" }, (0, helpers_1.truncate)(product === null || product === void 0 ? void 0 : product.title)),
                enableOkendoStarRating && react_1.default.createElement(addons_1.OkendoStarRating, { product: product }),
                react_1.default.createElement(tailwind_1.Typography, { color: "text.secondary", variant: "body2" }, (0, frontend_shopify_2.formatCurrency)((_c = (_b = product === null || product === void 0 ? void 0 : product.priceRange) === null || _b === void 0 ? void 0 : _b.minVariantPrice) === null || _c === void 0 ? void 0 : _c.amount))),
            react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
                ...
                enableQuickShop && (react_1.default.createElement(tailwind_1.Button, { variant: "contained", color: "secondary", onClick: handleQuickShop, className: "w-full" }, "Quick Shop")))),
