...
var Thumbnail = function (props) {
    ...
    return (react_1.default.createElement(button_1.Button, { variant: "ghost", className: "p-0 w-24 h-24 overflow-hidden rounded ".concat(active ? 'ring-2 ring-primary' : 'ring-2 ring-transparent'), onClick: function () { return handleClick(image); } },
