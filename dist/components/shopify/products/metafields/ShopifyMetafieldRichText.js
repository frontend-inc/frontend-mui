    ...
    var renderElement = function (el, key, inList) {
        switch (el.type) {
            ...
            case 'heading':
                ...
                return (react_1.default.createElement(HeadingTag, { key: key, className: (0, utils_1.cn)('font-bold', el.level === 1 && 'text-4xl', el.level === 2 && 'text-3xl', el.level === 3 && 'text-2xl', el.level === 4 && 'text-xl', el.level === 5 && 'text-lg', el.level === 6 && 'text-base') }, renderValue(el.children, inList)));
            case 'list':
                var ListTag = el.listType === 'ordered' ? 'ol' : 'ul';
                return (react_1.default.createElement(ListTag, { key: key, className: (0, utils_1.cn)('pl-5 my-4', el.listType === 'ordered' ? 'list-decimal' : 'list-disc') }, renderValue(el.children, true)));
            case 'list-item':
