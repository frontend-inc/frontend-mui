...
var ShopifyProductDetails = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-col sm:flex-row', 'w-full') },
        react_1.default.createElement("div", { className: (0, utils_1.cn)('w-full sm:w-1/2', 'p-0 sm:p-1') },
