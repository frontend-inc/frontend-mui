...
var ShopifyCheckoutButton = function (props) {
    ...
    return (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, color: "primary", onClick: handleCheckoutClick, variant: "contained", size: "large", loading: loading }, "Checkout"));
};
