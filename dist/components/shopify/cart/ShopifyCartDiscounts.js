...
var ShopifyCartDiscountCodeInput = function () {
    ...
    return (react_1.default.createElement("div", { className: "px-1 flex flex-row justify-center items center space-x-1" },
        react_1.default.createElement(tailwind_1.TextField, { fullWidth: true, name: "discountCode", value: discountCode, handleChange: handleChange, placeholder: "Enter discount code", className: "rounded-l-md rounded-r-none border-r-0" }),
        react_1.default.createElement(tailwind_1.Button, { onClick: handleSubmit, color: "secondary", variant: "contained", className: "rounded-l-none rounded-r-md", loading: loading }, "Apply")));
};
