...
var ShopifyCartQuantityInput = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "inline-flex rounded-md shadow-sm", role: "group" },
        react_1.default.createElement(button_1.Button, { variant: "secondary", size: "sm", className: "px-2 rounded-r-none", onClick: handleRemoveQuantity },
            react_1.default.createElement(components_1.Icon, { name: "Minus", size: 16 })),
        react_1.default.createElement(button_1.Button, { variant: "secondary", size: "sm", className: "px-2 rounded-none" }, quantity),
        react_1.default.createElement(button_1.Button, { variant: "secondary", size: "sm", className: "px-2 rounded-l-none", onClick: handleAddQuantity },
...
var ShopifyCartLine = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex items-start space-x-4 py-4', loading && 'opacity-30') },
        react_1.default.createElement(tailwind_1.Badge, { badgeContent: quantity },
        ...
        react_1.default.createElement("div", { className: "flex-grow" },
            react_1.default.createElement(tailwind_1.Typography, { variant: "body1" }, (_e = (_d = line === null || line === void 0 ? void 0 : line.merchandise) === null || _d === void 0 ? void 0 : _d.product) === null || _e === void 0 ? void 0 : _e.title),
            react_1.default.createElement(tailwind_1.Typography, { variant: "body1", className: "text-muted-foreground" }, (_h = (_g = (_f = line === null || line === void 0 ? void 0 : line.merchandise) === null || _f === void 0 ? void 0 : _f.selectedOptions) === null || _g === void 0 ? void 0 : _g.filter(function (option) { return option.name !== 'Title'; })) === null || _h === void 0 ? void 0 : _h.map(function (option) { return option.value; }).join(' / ')),
        ...
        react_1.default.createElement(button_1.Button, { variant: "ghost", size: "icon", className: "text-muted-foreground", onClick: handleRemoveLineItem },
