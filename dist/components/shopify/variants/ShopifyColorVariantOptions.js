...
var ShopifyColorVariantsOptions = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col items-start justify-center", style: styles },
        react_1.default.createElement("div", { className: "flex flex-row flex-wrap gap-2.5" }, values === null || values === void 0 ? void 0 : values.map(function (value) {
            ...
            return (react_1.default.createElement("button", { key: value, className: (0, utils_1.cn)('p-0 overflow-hidden rounded-lg border-3 border-transparent hover:opacity-85 transition-opacity', 'focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2', selected === value && 'border-primary opacity-100'), onClick: function () { return handleChange(name, value); } },
