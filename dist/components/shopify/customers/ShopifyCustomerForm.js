...
var ShopifyCustomerForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-3" },
        ...
        react_1.default.createElement(tailwind_1.Button, { color: "secondary", endIcon: loading && react_1.default.createElement(__1.IconLoading, null), variant: "contained", onClick: handleSubmit }, "Update Account")));
};
