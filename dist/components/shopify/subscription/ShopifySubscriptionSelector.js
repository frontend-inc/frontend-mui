...
var ShopifySubscriptionSelector = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "w-full" },
        react_1.default.createElement(select_1.Select, { onValueChange: handleChange, value: activeSellingPlanId },
            react_1.default.createElement(select_1.SelectTrigger, { className: "w-full" },
                react_1.default.createElement(select_1.SelectValue, { placeholder: "Select a subscription" })),
            react_1.default.createElement(select_1.SelectContent, null,
                ...
                sellingPlans.map(function (sellingPlan) { return (react_1.default.createElement(select_1.SelectItem, { key: sellingPlan.id, value: sellingPlan.id }, sellingPlan === null || sellingPlan === void 0 ? void 0 :
                    sellingPlan.name,
                    " - ",
