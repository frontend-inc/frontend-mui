...
var ShopifyForgotPasswordForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        ...
        react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit }, "Send Instructions"),
        handleLogin && (react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "text", color: "primary", onClick: handleLogin }, "Back to Login"))));
};
