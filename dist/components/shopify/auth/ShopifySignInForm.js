...
var SignInForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4" },
        ...
        handleSignup && (react_1.default.createElement(tailwind_1.Button, { className: "w-full", variant: "text", onClick: handleSignup }, "No account? Sign up")),
        handleForgotPassword && (react_1.default.createElement(tailwind_1.Button, { className: "w-full", variant: "text", onClick: handleForgotPassword }, "Forgot password?"))));
};
