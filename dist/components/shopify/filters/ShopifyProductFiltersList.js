...
var ShopifyProductFiltersList = function (props) {
    ...
    return (react_1.default.createElement(accordion_1.Accordion, { type: "multiple", className: "w-full" },
        constants_1.SHOPIFY_SEARCH_FILTERS.map(function (filterType, i) {
            ...
            if (!option)
                return null;
            return (react_1.default.createElement(accordion_1.AccordionItem, { value: filterType.value, key: i },
                react_1.default.createElement(accordion_1.AccordionTrigger, { className: "text-sm font-medium" }, filterType.label),
        ...
        (priceOptions === null || priceOptions === void 0 ? void 0 : priceOptions.length) > 0 && (react_1.default.createElement(accordion_1.AccordionItem, { value: "price" },
            react_1.default.createElement(accordion_1.AccordionTrigger, { className: "text-sm font-medium" }, "Price"),
            react_1.default.createElement(accordion_1.AccordionContent, null,
