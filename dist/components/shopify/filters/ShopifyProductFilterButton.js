...
var ShopifyProductFilterButton = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "hidden sm:block" },
            react_1.default.createElement(popover_1.Popover, { open: open, onOpenChange: toggleMenu },
                react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
                    react_1.default.createElement(button_1.Button, { variant: "default", className: "w-full sm:w-auto", onClick: toggleMenu },
        ...
        react_1.default.createElement("div", { className: "sm:hidden" },
            react_1.default.createElement(sheet_1.Sheet, { open: open, onOpenChange: toggleMenu },
                react_1.default.createElement(sheet_1.SheetTrigger, { asChild: true },
                    react_1.default.createElement(button_1.Button, { variant: "default", className: "w-full", onClick: toggleMenu },
                        react_1.default.createElement(lucide_react_1.ListFilter, { className: "mr-2 h-4 w-4" }),
                        "Filter")),
