...
var SortList = function (props) {
    ...
    return (react_1.default.createElement(radio_group_1.RadioGroup, { value: "".concat(value, "-").concat(reverse), onValueChange: function (newValue) {
        ...
        react_1.default.createElement(radio_group_1.RadioGroupItem, { value: "".concat(option.value, "-").concat(option.reverse), id: "option-".concat(index) }),
        react_1.default.createElement(label_1.Label, { htmlFor: "option-".concat(index), className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" }, option.label))); })));
};
