        ...
        react_1.default.createElement("div", { className: "hidden sm:block" },
            react_1.default.createElement(popover_1.Popover, { open: open, onOpenChange: setOpen },
                react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
                    react_1.default.createElement(button_1.Button, { variant: "secondary", className: "w-full sm:w-auto", onClick: handleOpen },
                        currentSortLabel,
                        react_1.default.createElement(lucide_react_1.ArrowUpDown, { className: "ml-2 h-4 w-4" }))),
                react_1.default.createElement(popover_1.PopoverContent, { className: "w-56" },
        ...
        react_1.default.createElement("div", { className: "sm:hidden" },
            react_1.default.createElement(sheet_1.Sheet, { open: open, onOpenChange: setOpen },
                react_1.default.createElement(sheet_1.SheetTrigger, { asChild: true },
                    react_1.default.createElement(button_1.Button, { variant: "secondary", className: "w-full", onClick: handleOpen },
                        currentSortLabel,
                        react_1.default.createElement(lucide_react_1.ArrowUpDown, { className: "ml-2 h-4 w-4" }))),
                react_1.default.createElement(sheet_1.SheetContent, { side: "right" },
                    react_1.default.createElement(SortList_1.default, { enableIcons: true, value: sortKey, reverse: reverse, options: frontend_shopify_1.COLLECTION_SORT_OPTIONS, handleClick: handleSortClick }))))));
};
