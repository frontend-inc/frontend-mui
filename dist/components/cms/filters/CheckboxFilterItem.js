    ...
    return (react_1.default.createElement("li", { className: "list-none" },
        react_1.default.createElement("button", { className: "flex items-center w-full px-0 py-2 hover:bg-accent hover:text-accent-foreground", onClick: handleClick },
            react_1.default.createElement("div", { className: "mr-1" },
                react_1.default.createElement(checkbox_1.Checkbox, { checked: values.includes(option.value), onCheckedChange: handleClick })),
            react_1.default.createElement(tailwind_1.Typography, { color: "text.primary", variant: "button" }, option === null || option === void 0 ? void 0 : option.label))));
};
