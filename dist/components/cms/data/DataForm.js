...
var DataForm = function (props) {
    ...
    return (react_1.default.createElement(__1.Drawer, { open: openEdit, handleClose: function () { return setOpenEdit(false); }, title: (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Edit' : 'Add', buttons: react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, loading: loading }, (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Update' : 'Save') },
