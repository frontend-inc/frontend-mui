...
var CarouselLeftArrow = function (props) {
    return (react_1.default.createElement(button_1.Button, { variant: "outline", size: "icon", className: "absolute left-5 top-[28%] h-8 w-8 sm:h-12 sm:w-12 shadow-md opacity-80 hover:opacity-90 bg-background hover:bg-background" },
