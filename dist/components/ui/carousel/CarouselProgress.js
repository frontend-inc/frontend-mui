...
var CarouselProgress = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('space-y-4', className) },
        ...
        react_1.default.createElement("div", { className: "flex flex-col items-center space-y-2" },
            react_1.default.createElement(progress_1.Progress, { value: ((currentStep + 1) / children.length) * 100, className: "w-full" }),
            react_1.default.createElement("div", { className: "flex justify-center items-center space-x-4" },
                react_1.default.createElement(button_1.Button, { variant: "outline", size: "icon", onClick: handlePrevStep },
                    react_1.default.createElement(lucide_react_1.ChevronLeft, { className: "h-4 w-4" })),
                react_1.default.createElement(button_1.Button, { variant: "outline", size: "icon", onClick: handleNextStep },
