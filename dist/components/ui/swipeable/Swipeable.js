...
var Swipeable = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('w-full relative', className) },
        ...
        enableArrows && (react_1.default.createElement("div", { className: "absolute top-1/2 transform -translate-y-1/2 flex justify-between w-full z-10" },
            react_1.default.createElement(tailwind_1.IconButton, { color: "ghost", onClick: handlePrev, className: "ml-2" },
                react_1.default.createElement(__1.Icon, { name: "ChevronLeft", size: 32 })),
            react_1.default.createElement(tailwind_1.IconButton, { color: "ghost", onClick: handleNext, className: "mr-2" },
