...
var Hero = function (props) {
    ...
    return (react_1.default.createElement(Component, { primary: title, secondary: react_1.default.createElement(tailwind_1.Typography, { variant: "body1", color: "text.secondary" }, description), image: image, secondaryAction: buttons && react_1.default.createElement(components_1.ButtonActions, { buttons: buttons }) }));
};
