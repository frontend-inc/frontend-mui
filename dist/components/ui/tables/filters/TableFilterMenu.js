...
var TableFilterMenu = function (_a) {
    ...
    return (react_1.default.createElement(popover_1.Popover, null,
        react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
            react_1.default.createElement(button_1.Button, { variant: "outline", className: "w-10 rounded-full p-0" },
        ...
        react_1.default.createElement(popover_1.PopoverContent, { className: "w-80 p-0" },
            react_1.default.createElement("div", { className: "bg-background max-w-[420px] w-full" },
                ...
                react_1.default.createElement("div", { className: "p-4" },
                    ...
                    react_1.default.createElement(button_1.Button, { className: "w-full mt-2", onClick: handleSearch },
