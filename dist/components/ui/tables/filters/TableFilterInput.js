    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("div", { className: "flex flex-row justify-start items-start" },
            react_1.default.createElement("div", null,
                react_1.default.createElement(components_1.TabsInput, { name: "where", options: index_1.BOOLEAN_OPTIONS, value: (filter === null || filter === void 0 ? void 0 : filter.where) || 'AND', handleChange: function (ev) { return handleChange(ev, index); } }),
