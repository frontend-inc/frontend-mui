                ...
                react_1.default.createElement(tailwind_1.Hidden, { mdDown: true },
                    react_1.default.createElement("div", { className: "flex flex-row space-x-1" },
                        (selected === null || selected === void 0 ? void 0 : selected.length) > 0 && (react_1.default.createElement(react_1.default.Fragment, null,
                            enableDelete && (react_1.default.createElement(button_1.Button, { color: "secondary", onClick: function () { return handleDelete(selected); } }, "Delete")),
                            enableEdit && (react_1.default.createElement(react_1.default.Fragment, null,
                                react_1.default.createElement(button_1.Button, { color: "secondary", onClick: function () { return handlePublish(selected); } }, "Publish"),
                                react_1.default.createElement(button_1.Button, { color: "secondary", onClick: function () { return handleUnpublish(selected); } }, "Unpublish"))))),
                        secondaryActions && secondaryActions)),
                react_1.default.createElement(tailwind_1.Hidden, { mdUp: true },
                    react_1.default.createElement("div", { className: "flex flex-row justify-start items-center" },
                        react_1.default.createElement(tailwind_2.Badge, { badgeContent: badgeCount },
                            react_1.default.createElement(tailwind_1.IconButton, { onClick: handleFilter },
                                react_1.default.createElement(lucide_react_1.Filter, { className: "w-5 h-5 text-foreground" }))),
                        (selected === null || selected === void 0 ? void 0 : selected.length) > 0 && (react_1.default.createElement(react_1.default.Fragment, null,
                            enableDelete && (react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return handleDelete(selected); } },
                                react_1.default.createElement(lucide_react_1.Trash, { className: "w-5 h-5 text-foreground" }))),
                            enableEdit && (react_1.default.createElement(tailwind_1.IconButton, { onClick: function () { return handleEdit(selected); } },
