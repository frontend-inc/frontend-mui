...
var pagination_1 = require("../../shadcn/ui/pagination");
...
var Pagination = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "p-2 flex flex-row justify-between items-center border-t border-divider w-full" },
        ...
        react_1.default.createElement("div", null,
            react_1.default.createElement(pagination_1.Pagination, null,
                react_1.default.createElement(pagination_1.PaginationContent, null,
                    react_1.default.createElement(pagination_1.PaginationItem, null,
                        react_1.default.createElement(button_1.Button, { variant: "outline", onClick: function () { return handleChangePage(Math.max(1, pageNumber - 1)); }, disabled: pageNumber === 1, className: "text-foreground" }, "Previous")),
                    Array.from({ length: numPages }, function (_, i) { return i + 1; }).map(function (num) { return (react_1.default.createElement(pagination_1.PaginationItem, { key: num },
                        react_1.default.createElement(button_1.Button, { variant: num === pageNumber ? 'default' : 'outline', size: "sm", onClick: function () { return handleChangePage(num); } }, num))); }),
                    react_1.default.createElement(pagination_1.PaginationItem, null,
