...
var ButtonActions = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-row', {
            'justify-start': justifyContent === 'start',
            'justify-center': justifyContent === 'center',
            'justify-end': justifyContent === 'end',
        }) }, (buttons === null || buttons === void 0 ? void 0 : buttons.length) > 0 && (react_1.default.createElement("div", { className: (0, utils_1.cn)('w-full flex flex-col sm:flex-row gap-1', {
            'justify-start': justifyContent === 'start',
            'justify-center': justifyContent === 'center',
            'justify-end': justifyContent === 'end',
