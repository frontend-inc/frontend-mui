...
function Notifications(_a) {
    ...
    if (!(notifications === null || notifications === void 0 ? void 0 : notifications.length))
        return null;
    return (react_1.default.createElement("div", { className: "w-full relative top-0 left-0 p-0 h-11" },
        react_1.default.createElement(react_swipeable_views_1.default, { axis: 'x', index: activeStep, onChangeIndex: handleStepChange, enableMouseEvents: true, containerStyle: {
            ...
            }, className: "w-full h-full" }, notifications.map(function (notification, i) { return (react_1.default.createElement("div", { key: i, className: "w-full" },
            react_1.default.createElement(components_1.Notification, { notification: notification }))); })),
        (notifications === null || notifications === void 0 ? void 0 : notifications.length) > 0 && (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: "absolute top-0 left-0 bottom-0 flex items-center" },
                react_1.default.createElement(tailwind_1.IconButton, { onClick: handlePrev, className: "px-1 py-2" },
            ...
            react_1.default.createElement("div", { className: "absolute top-0 left-[32px] bottom-0 flex items-center" },
                react_1.default.createElement(tailwind_1.IconButton, { onClick: handleNext, className: "h-full px-1 py-2" },
