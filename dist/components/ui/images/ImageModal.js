...
var ImageModal = function (props) {
    ...
    return (react_1.default.createElement(components_1.Modal, { mode: "editor", open: open, handleClose: handleClose, title: title, maxWidth: "md", buttons: react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(tailwind_1.Button, { color: "secondary", variant: "contained", onClick: handleCopyUrlClick }, "Copy URL"),
            react_1.default.createElement(tailwind_1.Button, { variant: "contained", onClick: handleDownloadClick }, "Download")) },
