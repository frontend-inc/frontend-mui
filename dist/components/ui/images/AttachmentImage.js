...
var AttachmentImage = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex items-center justify-center bg-primary', height ? "h-[".concat(height, "px]") : 'h-auto', width ? "w-[".concat(width, "px]") : 'w-full', className) },
