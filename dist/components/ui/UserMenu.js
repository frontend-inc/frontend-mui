...
var UserMenu = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex w-full justify-center" },
        react_1.default.createElement(dropdown_menu_1.DropdownMenu, null,
            ...
            react_1.default.createElement(dropdown_menu_1.DropdownMenuContent, { className: "w-56", align: "end", forceMount: true },
                react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleClick },
                ...
                react_1.default.createElement(dropdown_menu_1.DropdownMenuItem, { onClick: handleLogoutClick },
