...
var JsonbInput = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        ...
        react_1.default.createElement("div", null,
            react_1.default.createElement(tailwind_1.Button, { color: "secondary", variant: "contained", onClick: handleAddClick, startIcon: react_1.default.createElement(lucide_react_1.Plus, { size: 24 }) }, "Add")),
        react_1.default.createElement(__1.Drawer, { title: title, open: open, handleClose: closeMenu, buttons: react_1.default.createElement(tailwind_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit }, "Save") },
