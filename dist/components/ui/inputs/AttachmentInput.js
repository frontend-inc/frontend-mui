...
function RenderAttachment(_a) {
    ...
    return (react_1.default.createElement("div", { className: "relative" },
        ...
        variant === 'file' && (react_1.default.createElement(avatar_1.Avatar, { className: "h-16 w-16 bg-primary" },
        ...
        react_1.default.createElement(button_1.Button, { variant: "outline", size: "icon", className: (0, utils_1.cn)('text-foreground absolute -top-3 left-2 h-6 w-6 rounded-full', variant === 'file' && 'left-12 -top-1'), onClick: onDelete },
...
function AttachmentInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col w-full" },
        ...
        !(attachment === null || attachment === void 0 ? void 0 : attachment.url) && !src && (react_1.default.createElement("div", { className: "border-2 border-dashed border-border rounded-lg p-6 text-center" },
            react_1.default.createElement("input", { type: "file", className: "hidden", onChange: function (e) {
                    var _a;
                    var file = (_a = e.target.files) === null || _a === void 0 ? void 0 : _a[0];
                    if (file) {
                        onDrop(file, { src: URL.createObjectURL(file) });
                    }
                }, id: "dropzone-".concat(name) }),
            react_1.default.createElement("label", { htmlFor: "dropzone-".concat(name), className: "cursor-pointer font-semibold text-foreground hover:text-foreground-dark" }, placeholder)))));
}
