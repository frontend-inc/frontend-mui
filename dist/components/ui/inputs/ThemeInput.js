...
function ThemePicker(_a) {
    ...
    return (react_1.default.createElement(popover_1.Popover, null,
        react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
            react_1.default.createElement(button_1.Button, { variant: "outline", className: "w-[200px] text-foreground justify-between" },
        ...
        react_1.default.createElement(popover_1.PopoverContent, { className: "w-[200px] p-0" },
            react_1.default.createElement("div", { className: "grid grid-cols-5 gap-1 p-2" }, constants_1.TAILWIND_COLORS.map(function (color) { return (react_1.default.createElement(tooltip_1.TooltipProvider, { key: color },
                react_1.default.createElement(tooltip_1.Tooltip, null,
                    react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                        react_1.default.createElement("button", { className: (0, utils_1.cn)('h-8 w-8 rounded-md border', value === color &&
