    ...
    return (react_1.default.createElement("div", { className: "w-full" },
        ...
        react_1.default.createElement("div", { className: "flex flex-row items-center justify-between w-full" },
            react_1.default.createElement("div", { className: "relative flex-1" },
                ...
                react_1.default.createElement(input_1.Input, { type: "number", onChange: handleMinChange, value: value === null || value === void 0 ? void 0 : value.min, className: (0, utils_1.cn)('pr-2', startAdornment && 'pl-8') })),
            ...
            react_1.default.createElement("div", { className: "relative flex-1" },
                ...
                react_1.default.createElement(input_1.Input, { type: "number", value: value === null || value === void 0 ? void 0 : value.max, onChange: handleMaxChange, className: (0, utils_1.cn)('pr-2', startAdornment && 'pl-8') })))));
}
