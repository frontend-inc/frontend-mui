...
var slider_1 = require("../../../shadcn/ui/slider");
    ...
    return (react_1.default.createElement("div", { className: "w-full space-y-2" },
        ...
        react_1.default.createElement(popover_1.Popover, null,
            react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
                react_1.default.createElement(button_1.Button, { variant: "outline", className: "text-foreground w-full justify-between" },
                    placeholder,
            ...
            react_1.default.createElement(popover_1.PopoverContent, { className: "w-64" },
                react_1.default.createElement("div", { className: "grid grid-cols-7 gap-3 mb-2" },
                    react_1.default.createElement(tooltip_1.TooltipProvider, null,
                        react_1.default.createElement(tooltip_1.Tooltip, null,
                            react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                                react_1.default.createElement("button", { className: (0, utils_1.cn)('relative bg-white h-8 w-8 rounded-md border overflow-hidden', value === '' &&
                    ...
                    react_1.default.createElement(tooltip_1.TooltipProvider, null,
                        react_1.default.createElement(tooltip_1.Tooltip, null,
                            react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                                react_1.default.createElement("button", { className: (0, utils_1.cn)('h-8 w-8 rounded-md border', selectedColorName === 'white' &&
                    ...
                    react_1.default.createElement(tooltip_1.TooltipProvider, null,
                        react_1.default.createElement(tooltip_1.Tooltip, null,
                            react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                                react_1.default.createElement("button", { className: (0, utils_1.cn)('h-8 w-8 rounded-md border', selectedColorName === 'black' &&
                    ...
                    Object.keys(constants_1.TAILWIND_COLOR_PICKER_MAP).map(function (color) { return (react_1.default.createElement(tooltip_1.TooltipProvider, { key: color },
                        react_1.default.createElement(tooltip_1.Tooltip, null,
                            react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                                react_1.default.createElement("button", { className: (0, utils_1.cn)('h-8 w-8 rounded-md border', value === constants_1.TAILWIND_COLOR_PICKER_MAP[color][tone] &&
                ...
                !disableTone && (react_1.default.createElement("div", { className: "space-y-2" },
                    ...
                    react_1.default.createElement(slider_1.Slider, { min: 100, max: 900, step: 100, value: [tone], onValueChange: handleToneChange }))),
                react_1.default.createElement("div", { className: "mt-2" },
                    react_1.default.createElement(input_1.Input, { placeholder: "#RRGGBB", value: (value === null || value === void 0 ? void 0 : value.startsWith('#')) ? value : '', onChange: handleHexColorChange }))))));
}
