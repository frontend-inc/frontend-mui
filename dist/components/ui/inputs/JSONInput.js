...
function JSONInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: "w-full" },
        ...
        react_1.default.createElement(textarea_1.Textarea, { className: (0, utils_1.cn)('font-mono', hasError && 'border-red-500 focus-visible:ring-red-500'), value: jsonValue, placeholder: placeholder, onChange: handleJSONChange, name: name, rows: 6 }),
