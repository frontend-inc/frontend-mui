...
function InputBase(_a) {
    ...
    return (react_1.default.createElement("div", { className: "relative w-full" },
        react_1.default.createElement(input_1.Input, { className: (0, utils_1.cn)(className, 'w-full text-foreground', error && 'border border-destructive'), type: type, name: name, disabled: disabled, placeholder: placeholder, onChange: handleInputChange, value: text, autoComplete: "off" }),
