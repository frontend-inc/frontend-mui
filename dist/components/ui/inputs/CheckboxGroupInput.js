...
function CheckboxGroupInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: "w-full" },
        ...
        react_1.default.createElement("div", { className: "space-y-2" }, options === null || options === void 0 ? void 0 : options.map(function (option, idx) { return (react_1.default.createElement("div", { key: idx, className: "flex items-center space-x-2" },
            react_1.default.createElement(checkbox_1.Checkbox, { id: "".concat(name, "-").concat(option.value), checked: values.includes(String(option.value)), onCheckedChange: function (checked) {
                    return handleCheckboxChange(checked, String(option.value));
                } }),
            react_1.default.createElement("label", { htmlFor: "".concat(name, "-").concat(option.value), className: (0, utils_1.cn)('text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70', errors && errors[name] ? 'text-red-500' : 'text-gray-500') }, option.label))); })),
