...
var command_1 = require("../../../shadcn/ui/command");
    ...
    return (react_1.default.createElement(popover_1.Popover, { open: open, onOpenChange: setOpen },
        react_1.default.createElement("div", { className: "flex flex-col space-y-2 w-full" },
            ...
            react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
                react_1.default.createElement(button_1.Button, { variant: "outline", role: "combobox", "aria-expanded": open, className: (0, utils_1.cn)('min-w-[220px] w-full text-foreground justify-between font-normal') },
        ...
        react_1.default.createElement(popover_1.PopoverContent, { className: "w-[200px] p-0" },
            react_1.default.createElement(command_1.Command, null,
                react_1.default.createElement(command_1.CommandInput, { onValueChange: handleCommandChange, placeholder: placeholder }),
                react_1.default.createElement(command_1.CommandList, null,
                    react_1.default.createElement(command_1.CommandEmpty, null, "No option found."),
                    react_1.default.createElement(command_1.CommandGroup, null, options.map(function (option) { return (react_1.default.createElement(command_1.CommandItem, { key: option.value, value: option.label, onSelect: handleSelect },
