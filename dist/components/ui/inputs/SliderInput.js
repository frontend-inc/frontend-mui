...
var SliderInput = function (props) {
    ...
    return (react_1.default.createElement(slider_1.Slider, { name: name, defaultValue: value, onValueChange: handleChange, step: stepSize, min: min, max: max, value: value, className: (0, utils_1.cn)('w-full', className) }));
};
