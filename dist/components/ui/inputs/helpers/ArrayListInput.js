...
var ArrayListInput = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col gap-2" },
        label && (react_1.default.createElement(tailwind_1.Typography, { variant: "caption", color: "text.secondary" }, label)),
        ...
        react_1.default.createElement("div", null,
            react_1.default.createElement(tailwind_1.Button, { variant: "contained", color: "secondary", onClick: handleAddClick, startIcon: react_1.default.createElement(lucide_react_1.Plus, { className: "w-5 h-5 text-foreground" }) }, "Add"))));
};
