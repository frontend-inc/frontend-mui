...
var DropZone = function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({}, getRootProps(), { className: "m-px p-4 flex flex-col justify-center items-center rounded border-2 border-border bg-background text-center hover:border-2 hover:border-primary hover:cursor-pointer transition-all duration-300" }),
        ...
        loading ? (react_1.default.createElement("div", { className: "animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-blue-500" })) : (react_1.default.createElement(react_1.default.Fragment, null,
            isDragActive ? (react_1.default.createElement(lucide_react_1.DownloadCloud, { className: "text-foreground w-8 h-8" })) : (react_1.default.createElement(lucide_react_1.UploadCloud, { className: "text-foreground w-8 h-8" })),
