...
function ArrayInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex w-full space-y-2', direction === 'row' ? 'flex-row items-center' : 'flex-col') },
        ...
        react_1.default.createElement("div", { className: "relative w-full" },
            react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-wrap gap-2 p-1 border rounded-md min-h-[42px]', error && 'border-red-500') },
                value.map(function (tag) { return (react_1.default.createElement(badge_1.Badge, { key: tag, variant: "secondary", className: "text-sm" },
                    tag,
                ...
                react_1.default.createElement(input_1.Input, { type: "text", placeholder: placeholder, value: inputValue, onChange: function (e) { return setInputValue(e.target.value); }, onKeyDown: handleKeyDown, onBlur: function () { return addTag(inputValue); }, className: "text-foreground flex-1 px-0 py-0 text-sm border-0 focus-visible:ring-0 focus-visible:ring-offset-0" })),
