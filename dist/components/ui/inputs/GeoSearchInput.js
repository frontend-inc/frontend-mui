...
function GeoSearchInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex items-center border border-input rounded-md overflow-hidden transition-shadow hover:shadow-md', fullWidth ? 'w-full' : 'max-w-md min-w-[320px]', className) },
        react_1.default.createElement(input_1.Input, { className: "flex-1 border-none focus:ring-0 focus:ring-offset-0", placeholder: placeholder, value: text, onChange: handleInputChange, onKeyDown: function (e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
        ...
        react_1.default.createElement(input_1.Input, { className: "flex-1 border-none focus:ring-0 focus:ring-offset-0", placeholder: "Location...", value: locationText, onChange: handleLocationInputChange, onKeyDown: function (e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    handleSearch(text, locationText);
                }
            } }),
        react_1.default.createElement(button_1.Button, { onClick: function () { return handleSearch(text, locationText); }, type: "button", variant: "ghost", size: "icon", className: "mr-1" },
