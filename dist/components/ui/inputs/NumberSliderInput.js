...
function NumberSliderInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col items-start justify-start w-full px-0" },
        ...
        react_1.default.createElement(slider_1.Slider, { defaultValue: value, onValueChange: handleInputChange, step: stepSize, min: min, max: max, value: value, className: "w-full" })));
}
