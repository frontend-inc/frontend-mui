...
var calendar_1 = require("../../../shadcn/ui/calendar");
...
function DateInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex', direction === 'column'
            ? 'flex-col space-y-2'
        ...
        react_1.default.createElement(popover_1.Popover, null,
            react_1.default.createElement(popover_1.PopoverTrigger, { asChild: true },
                react_1.default.createElement(button_1.Button, { variant: "outline", className: (0, utils_1.cn)('min-w-[200px] text-foreground w-full justify-start text-left font-normal', !date && 'text-muted-foreground', error && 'border-red-500') },
            ...
            react_1.default.createElement(popover_1.PopoverContent, { className: "w-auto p-0" },
                react_1.default.createElement(calendar_1.Calendar, { mode: "single", selected: date, onSelect: handleDateSelect }))),
