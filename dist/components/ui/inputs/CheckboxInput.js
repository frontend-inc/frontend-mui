...
function CheckboxInput(_a) {
    ...
    return (react_1.default.createElement("div", { className: "w-full" },
        ...
        react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-col text-sm', !disableBorder && 'border border-input shadow-sm rounded-md p-2') },
            react_1.default.createElement("div", { className: "flex items-center space-x-2" },
                react_1.default.createElement(checkbox_1.Checkbox, { id: name, checked: value, onCheckedChange: handleCheckboxChange, className: "border-secondary" }),
