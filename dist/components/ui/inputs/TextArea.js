...
function TextArea(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('flex flex-col space-y-2 w-full', direction === 'row' && 'sm:flex-row sm:items-start') },
        ...
        react_1.default.createElement("div", { className: "relative w-full" },
            react_1.default.createElement(textarea_1.Textarea, { className: (0, utils_1.cn)('w-full text-foreground resize-none min-w-[230px]', error && 'border-red-500'), name: name, disabled: disabled, placeholder: placeholder, onChange: handleTextAreaChange, value: text, rows: rows }),
