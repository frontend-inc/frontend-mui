...
var SearchInput = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "max-w-[400px] w-full" },
        react_1.default.createElement("form", { onSubmit: function (e) {
                e.preventDefault();
                handleSearch(text);
            }, className: (0, utils_1.cn)('flex items-center w-full border border-input rounded-md transition-shadow hover:shadow-md', fullWidth ? 'w-full' : 'max-w-[400px] min-w-[320px] sm:min-w-full') },
            react_1.default.createElement(input_1.Input, { type: "text", placeholder: placeholder, value: text, onChange: handleInputChange, className: "text-foreground flex-grow border-none focus-visible:ring-0 focus-visible:ring-offset-0" }),
            react_1.default.createElement("div", { className: "h-7 border-l border-input" }),
            react_1.default.createElement(tailwind_1.IconButton, { className: "m-1", onClick: function () { return handleSearch(text); } },
