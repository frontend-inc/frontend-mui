    ...
    return (react_1.default.createElement("div", { className: "p-4 w-full flex justify-between items-center flex-col sm:flex-row" },
        react_1.default.createElement("div", { className: "w-full flex flex-col justify-between" },
            react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
                label && (react_1.default.createElement("div", { className: (0, utils_1.cn)(textAlign === 'center' && 'text-center', textAlign === 'right' && 'text-right') },
                    react_1.default.createElement(components_1.Label, { variant: "outline", label: label }))),
                title && (react_1.default.createElement(tailwind_1.Typography, { variant: textVariant, textAlign: textAlign }, title)),
                description && (react_1.default.createElement(tailwind_1.Typography, { variant: "body1", className: "text-muted-foreground", textAlign: textAlign }, description))),
            secondaryAction)));
};
