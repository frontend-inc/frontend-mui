...
var TableCard = function (props) {
    ...
    return (react_1.default.createElement("div", __assign({ className: (0, utils_1.cn)('w-full flex flex-row flex-nowrap pt-1 pb-2 overflow-hidden border-b border-border justify-between') }, slots.item),
