...
function VideoCard(_a) {
    ...
    return (react_1.default.createElement("div", { className: "dark" },
        react_1.default.createElement("div", __assign({ className: (0, utils_1.cn)('relative flex flex-col overflow-hidden rounded', 'transition-shadow duration-300 hover:shadow-md', "after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-1/2", 'after:bg-gradient-to-t after:from-black/50 after:to-transparent') }, slots.item),
            ...
            react_1.default.createElement("button", { className: (0, utils_1.cn)('absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2', 'flex items-center justify-center', 'w-10 h-10 rounded-full bg-black/50'), onClick: handleClick },
