...
var KanBanCard = function (props) {
    ...
    return (react_1.default.createElement(card_1.Card, __assign({ ref: setNodeRef, style: style }, attributes, listeners, { className: (0, utils_1.cn)('w-[260px] my-1 cursor-pointer overflow-hidden transition-shadow duration-300 hover:shadow-md', loading && 'opacity-50', enableDragging && 'shadow-md rotate-3') }, slots.item),
        ...
        react_1.default.createElement(card_1.CardFooter, { className: "flex justify-between p-4" },
            react_1.default.createElement(button_1.Button, { onClick: handleClick, size: "sm", variant: "secondary", className: "uppercase" }, "Details"),
