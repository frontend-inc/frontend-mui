...
function SubscriptionTable() {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: (0, utils_1.cn)('w-full flex justify-center items-center', 'sm:flex-row flex-col space-y-2 sm:space-y-0 sm:space-x-2', loading && 'opacity-50') }, subscriptions === null || subscriptions === void 0 ? void 0 : subscriptions.map(function (subscription) {
