...
var ProductCard = react_1.default.forwardRef(function (props, ref) {
    ...
    return (react_1.default.createElement("div", { ref: ref, className: (0, utils_1.cn)(!disableBorder && 'border border-border hover:shadow-md', 'w-full overflow-hidden rounded-lg transition-shadow duration-300 bg-background') },
        ...
        react_1.default.createElement("div", { className: "px-4 py-1 flex flex-col space-y-4 w-full justify-between items-between" },
            react_1.default.createElement("div", null,
                react_1.default.createElement(tailwind_1.Typography, { variant: "subtitle2" }, primary),
                react_1.default.createElement("div", { className: "flex flex-row space-x-2" },
                    react_1.default.createElement(tailwind_1.Typography, { className: "text-sm text-foreground", variant: "caption" }, price),
                    compareAtPrice && (react_1.default.createElement(tailwind_1.Typography, { className: "line-through", variant: "caption" }, compareAtPrice))),
                secondary && (react_1.default.createElement(tailwind_1.Typography, { className: "text-sm text-muted-foreground", variant: "body2" }, secondary))),
            addToCart,
