...
var LoadMore = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-row w-full justify-center items-center" },
        react_1.default.createElement(tailwind_1.Button, { color: "secondary", variant: "contained", onClick: handlePaginate, endIcon: react_1.default.createElement(components_1.Icon, { name: "ChevronDown" }) }, "Load More")));
};
