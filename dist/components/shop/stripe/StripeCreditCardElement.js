...
var StripeCreditCardElement = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4" },
        ...
        react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
            react_1.default.createElement(button_1.Button, { variant: "default", onClick: handleClick },
                react_1.default.createElement(__1.Icon, { name: "CreditCard", className: "mr-2 h-4 w-4" }),
                "Add Credit Card"),
            react_1.default.createElement(button_1.Button, { variant: "secondary", onClick: handleCancel }, "Cancel")),
