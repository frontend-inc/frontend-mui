...
var PDP = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        ...
        react_1.default.createElement("div", { className: "w-full flex justify-center items-center" },
            react_1.default.createElement("div", { className: "flex flex-row sm:space-x-10" },
                ...
                react_1.default.createElement("div", { className: "w-full md:w-1/2 flex flex-col space-y-3" },
                    react_1.default.createElement(tailwind_1.Typography, { variant: "h3" }, primary),
                    react_1.default.createElement("div", { className: "flex flex-row space-x-2" },
                        react_1.default.createElement(tailwind_1.Typography, { color: "text.primary", variant: "h6" }, price),
                        compareAtPrice && (react_1.default.createElement(tailwind_1.Typography, { color: "text.secondary", variant: "subtitle2", className: "line-through" }, compareAtPrice))),
                    secondary,
                    addToCart,
