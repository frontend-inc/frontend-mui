...
var ProductReviewForm = function () {
    ...
    return (react_1.default.createElement(__1.Drawer, { title: "Leave a review", open: openEdit, handleClose: function () { return setOpenEdit(false); }, buttons: react_1.default.createElement(button_1.Button, { className: "w-full", variant: "default", onClick: handleSubmit, disabled: loading },
