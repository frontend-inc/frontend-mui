    ...
    return (react_1.default.createElement(tooltip_1.TooltipProvider, null,
        react_1.default.createElement(tooltip_1.Tooltip, { delayDuration: 300 },
            react_1.default.createElement(tooltip_1.TooltipTrigger, { asChild: true },
                react_1.default.createElement("span", { className: (0, utils_1.cn)('inline-block', className) }, children)),
            react_1.default.createElement(tooltip_1.TooltipContent, { side: placement, sideOffset: 5, className: (0, utils_1.cn)('z-50 overflow-hidden rounded-md bg-primary px-3 py-1.5 text-xs text-primary-foreground animate-in fade-in-0 zoom-in-95', arrow &&
                ...
                title,
                arrow && (react_1.default.createElement("span", { className: (0, utils_1.cn)('absolute w-2 h-2 bg-primary rotate-45 transform', placement === 'top' &&
