...
function Rating(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('inline-flex', disabled && 'opacity-50 cursor-not-allowed', className) }, __spreadArray([], Array(max), true).map(function (_, index) {
        var filled = (hoverValue !== null ? hoverValue : value) > index;
        var halfFilled = precision === 0.5 &&
            (hoverValue !== null ? hoverValue : value) === index + 0.5;
        return (react_1.default.createElement("div", { key: index, className: (0, utils_1.cn)('relative cursor-pointer', sizeClasses[size], readOnly && 'cursor-default', disabled && 'cursor-not-allowed'), onMouseMove: function (e) { return handleMouseMove(e, index); }, onMouseLeave: handleMouseLeave, onClick: function () { return handleClick(index); } },
            ...
            halfFilled ? (react_1.default.createElement(lucide_react_1.StarHalf, { className: (0, utils_1.cn)('text-primary', sizeClasses[size]) })) : (react_1.default.createElement(lucide_react_1.Star, { className: (0, utils_1.cn)(filled ? 'text-primary' : 'text-muted-foreground', sizeClasses[size]), fill: filled ? 'currentColor' : 'none' }))));
    })));
}
