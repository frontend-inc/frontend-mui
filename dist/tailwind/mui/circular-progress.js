...
var CircularProgress = function (_a) {
    ...
    if (variant === 'indeterminate') {
        return (react_1.default.createElement(lucide_react_1.Loader2, { className: (0, utils_1.cn)('animate-spin', sizeClass, colorClass, className) }));
    }
    ...
    return (react_1.default.createElement("svg", { className: (0, utils_1.cn)(sizeClass, colorClass, className), viewBox: "0 0 32 32" },
