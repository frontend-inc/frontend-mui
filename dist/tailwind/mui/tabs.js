...
var Tab = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(tabs_1.TabsTrigger, { value: value, disabled: disabled }, label),
        react_1.default.createElement(tabs_1.TabsContent, { value: value }, children)));
};
exports.Tab = Tab;
var Tabs = function (_a) {
    ...
    return (react_1.default.createElement(tabs_1.Tabs, { value: activeTab, onValueChange: handleTabChange, className: (0, utils_1.cn)('w-full', className) },
        react_1.default.createElement(tabs_1.TabsList, { className: "grid w-full grid-cols-2 lg:grid-cols-4" }, react_1.default.Children.map(children, function (child) {
