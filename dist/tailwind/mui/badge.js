...
var Badge = function (_a) {
    ...
    var badgeClasses = (0, utils_1.cn)('absolute -top-2 -right-2 flex items-center justify-center', variant === 'standard'
    ...
    return (react_1.default.createElement("div", { className: (0, utils_1.cn)('relative inline-flex', className) },
        children,
