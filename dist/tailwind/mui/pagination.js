...
var Pagination = function (_a) {
    ...
    return (react_1.default.createElement("nav", { className: (0, utils_1.cn)('flex items-center justify-center', className), "aria-label": "pagination navigation" },
        react_1.default.createElement("ul", { className: "flex list-none" },
            react_1.default.createElement("li", null,
                react_1.default.createElement(button_1.Button, { variant: "outline", size: "icon", className: "mr-2", onClick: function () { return handleClick(page - 1); }, disabled: page === 1 || disabled, "aria-label": "Go to previous page" },
                    react_1.default.createElement(lucide_react_1.ChevronLeft, { className: "h-4 w-4" }))),
            itemList.map(function (item, index) { return (react_1.default.createElement("li", { key: index }, item === 'ellipsis' ? (react_1.default.createElement(button_1.Button, { variant: "ghost", size: "icon", className: "mx-1", disabled: true },
                react_1.default.createElement(lucide_react_1.MoreHorizontal, { className: "h-4 w-4" }))) : (react_1.default.createElement(button_1.Button, { variant: page === item ? 'default' : 'outline', size: "icon", className: "mx-1", onClick: function () { return handleClick(item); }, disabled: disabled, "aria-label": "Go to page ".concat(item), "aria-current": page === item ? 'page' : undefined }, item)))); }),
            react_1.default.createElement("li", null,
                react_1.default.createElement(button_1.Button, { variant: "outline", size: "icon", className: "ml-2", onClick: function () { return handleClick(page + 1); }, disabled: page === count || disabled, "aria-label": "Go to next page" },
