...
var Toolbar = function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({ className: (0, utils_1.cn)('flex items-center', variant === 'regular' ? 'min-h-[64px]' : 'min-h-[48px]', !disableGutters && 'px-4', className) }, props), children));
};
