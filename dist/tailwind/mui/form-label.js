...
var FormLabel = react_1.default.forwardRef(function (_a, ref) {
    ...
    return (react_1.default.createElement("label", __assign({ ref: ref, className: (0, utils_1.cn)('text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70', error && 'text-destructive', disabled && 'opacity-50 cursor-not-allowed', className) }, props),
        children,
